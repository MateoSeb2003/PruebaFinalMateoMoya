...
class UserModel extends ChangeNotifier {
  static const String _urlUsers = "https://9d5f-192-188-46-70.ngrok-free.app/api/Usuario/";
  static const String _urlClientes = "https://9d5f-192-188-46-70.ngrok-free.app/api/Cliente/";
      ...
      if (response.statusCode == 200) {
        ...
        if (responseUsr.statusCode == 200) {
          ...
          usr = (item['value'] as List)
            ...
            .map((e) => User.fromJson(e)).firstOrNull;
        }
